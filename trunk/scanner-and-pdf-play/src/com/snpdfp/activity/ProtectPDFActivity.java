  ...
  public void protect(View view) {
    if (srcFile == null || !srcFile.exists()) {
      ...
      if (password == null || confirmPassword == null || "".equals(password) || "".equals(confirmPassword)
        ...
        getAlertDialog().setTitle("Incomplete details")
            .setMessage("Password and Confirm Password fields are required, and they must match!")
            .setPositiveButton("OK", new DialogInterface.OnClickListener() {
              public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
              }
        ...
        if (SNPDFUtils.isProtected(srcFile)) {
          getAlertDialog().setTitle("Invalid selection")
              .setMessage("The PDF is already protected, cannot process further!")
              .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                  dialog.dismiss();
                }
