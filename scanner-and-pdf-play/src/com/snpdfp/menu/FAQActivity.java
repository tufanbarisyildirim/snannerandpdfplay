...
public class FAQActivity extends SNPDFActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		answer1.setText("Either goto the '" + R.string.open_snpdf_file + "' section OR browse to '"
			+ SNPDFPathManager.getRootDirectory().getAbsolutePath() + "' in phone directory.");
		...
		answer4.setText("Nopes, all options work on a new file. So your source file remains safe and untouched!");
		...
		answer5.setText("It is probably because you selected a big image, and the Auto-Fit option in settings is set to false. Change it to true.");
	}
