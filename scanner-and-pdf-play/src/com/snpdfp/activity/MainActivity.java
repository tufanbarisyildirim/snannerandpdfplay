...
public class MainActivity extends SNPDFActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (Intent.ACTION_SEND.equals(action) && type != null) {
      if (type.startsWith("image/")) {
        getAlertDialog().setTitle(SNPDFCContstants.APP_TITLE)
            .setMessage("Are you sure you want to convert the selected image into PDF?")
        ...
        getAlertDialog().setTitle(SNPDFCContstants.APP_TITLE)
            .setMessage("Are you sure you want to protect the selected PDF with a password?")
            .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
              public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                lockPDF(intent);
  ...
  private void showWelcomeMessage() {
    ...
    if (!mPrefs.getBoolean(snpdfSkipIntro, false)) {
      ...
      final View layout = inflater.inflate(R.layout.custom_fullimage_dialog,
  ...
  public void convertTXTFile(View view) {
    ...
    filePick.putExtra(SNPDFCContstants.FILE_TYPE, SNPDFCContstants.FILE_TYPE_TXT);
    startActivity(filePick);
  ...
  public void convertDocFile(View view) {
    Intent filePick = new Intent(this, FileToPDFActivity.class);
    filePick.putExtra(SNPDFCContstants.FILE_TYPE, SNPDFCContstants.FILE_TYPE_DOC);
    startActivity(filePick);
  ...
  public void convertHTMLFile(View view) {
    Intent filePick = new Intent(this, FileToPDFActivity.class);
    filePick.putExtra(SNPDFCContstants.FILE_TYPE, SNPDFCContstants.FILE_TYPE_HTML);
    startActivity(filePick);
  }
  ...
  private void convertImage(Intent intent) {
    ...
    pdfintent.putExtra(SNPDFCContstants.IMAGE_URI,
        getImagePathFromURI((Uri) intent.getParcelableExtra(Intent.EXTRA_STREAM)));
  ...
  private void lockPDF(Intent intent) {
    ...
    pdfintent.putExtra(SNPDFCContstants.FILE_URI,
        getFilePathFromURI((Uri) intent.getParcelableExtra(Intent.EXTRA_STREAM)));
    startActivity(pdfintent);
