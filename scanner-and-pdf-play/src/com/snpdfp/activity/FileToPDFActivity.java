...
public class FileToPDFActivity extends SNPDFActivity {
  ...
  private class FileConverter extends AsyncTask<String, Void, Boolean> {
    ...
    protected Boolean doInBackground(String... params) {
      ...
      try {
        pdfWriter = PdfWriter.getInstance(document, new FileOutputStream(mainFile));
        // open document
        document.open();
        pdfWriter.open();
    ...
    private void convertHTML(Document document, PdfWriter pdfWriter) throws IOException {
